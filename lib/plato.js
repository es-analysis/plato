...
exports.getOverviewReport = function (reports) {
  ...
  reports.forEach(function(report){
    ...
    summary.total.difficulty += report.complexity.aggregate.complexity.halstead.difficulty;
  ...
  summary.average.difficulty = (summary.total.difficulty / reports.length).toFixed(2);
