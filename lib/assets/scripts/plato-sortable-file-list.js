...
$(function sortable_file_list () {
  ...
  "use strict";
    ...
    var _sortByDifficulty = function _sortByDifficulty () {
        return _sortBy('data-difficulty');
    };
    ...
    var _byDifficulty = function () {
      _update_list(_sortByDifficulty());
    };
    ...
    $('button#button-difficulty').on('click', _byDifficulty);
